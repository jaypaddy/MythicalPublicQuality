...
reqmetric = CounterMetric("requestsmade", "Number of Requests made", scope_keys)
tempmetric = CounterMetric("qc_temperature", "Temperature", scope_keys)
pressuremetric = GaugeMetric("qc_pressure", "Pressure", scope_keys)
egametric = GaugeMetric("qc_ega", "EGA", scope_keys)
